...
public class Day25 extends AbstractDay {
    ...
    private Day25() {
        super(Day25.class.getCanonicalName().replaceAll("\\.", "/").toLowerCase());
        doorPrivKey = Integer.parseInt(lines.get(0));
        cardPrivKey = Integer.parseInt(lines.get(1));
    }

    private int transform(int subject, int loopSize) {
        long value = 1;
    ...
    private int findLoopSize(int subject, int privKey) {
        int value = 1;
        int loopSize = 0;
        while (value != privKey) {
            value *= subject;
    ...
    public String solve1() {
        int cardLoopSize = findLoopSize(7, cardPrivKey);
        int doorLoopSize = findLoopSize(7, doorPrivKey);
        int encryptionKey = transform(doorPrivKey, cardLoopSize);
        System.out.println(transform(cardPrivKey, doorLoopSize));
        return "1: " + encryptionKey;
    }
